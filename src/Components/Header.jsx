        ...
        <div className="mt-16 flex justify-between items-start px-4">
          <div>
            <div className="flex flex-col items-start justify-center">
              ...
              <p className="text-gray-400 cursor-pointer" title="Base name" onClick={() => copyToClipboard("senpaiii-kun.base.eth")}>@senpaiii-kun.base.eth</p>
            </div>
            <div className="flex flex-col mt-6 gap-2">
              ...
              <p className="text-gray-200 flex items-center gap-2 text-sm">
                <FaFacebook className="w-4 h-4" /> <a href="https://www.facebook.com/jaysonsenpai18" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">Facebook</a>
              </p>
              <p className="text-gray-200 flex items-center gap-2 text-sm">
                <SiFarcaster  className="w-4 h-4" /> <a href="https://warpcast.com/swenpai" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">Farcaster</a>
              </p>
              <p className="text-gray-200 flex items-center gap-2 text-sm">
                <FaGithub className="w-4 h-4" /> <a href="https://github.com/jaysonreales007" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">Github</a>
              </p>
              <p className="text-gray-200 flex items-center gap-2 text-sm">
          ...
          <a
            ...
            className="py-3 px-3 lg:px-4 lg:py-2 bg-blue-600 text-sm text-white rounded-full hover:bg-blue-700 transition-colors flex items-center"
          >
